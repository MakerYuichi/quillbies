...
function StudySessionContent() {
  ...
  // Orange theme starts at 74.4% down, habit buttons at 88.5%, action buttons at 68.3%
  const tooltipSteps = [
    {
      id: 'welcome',
    ...
    <View style={styles.container}>
      ...
      {themeType && (
        <ImageBackground
          ...
          resizeMode="contain"
        >
          {/* Volume Button - Positioned inside theme asset with relative positioning */}
          <View style={styles.volumeButtonContainer}>
            <TouchableOpacity
              style={styles.volumeButton}
              onPress={() => setShowVolumeSettings(true)}
              activeOpacity={0.8}
            >
      ...
      {/* Volume Button for non-themed view */}
      {!themeType && (
        <View style={styles.volumeButtonContainer}>
          <TouchableOpacity
            style={styles.volumeButton}
...
const styles = StyleSheet.create({
  ...
  studyShelf: {
    ...
    left: SCREEN_WIDTH * 0.611,  // 240/393
    top: SCREEN_HEIGHT * 0.088,  // 75/852
  ...
  photoFrame1: {
    ...
    left: SCREEN_WIDTH * 0.008,  // 3/393
    top: SCREEN_HEIGHT * 0.089,  // 76/852
  },
  ...
  photoFrame2: {
    ...
    left: SCREEN_WIDTH * 0.201,  // 79/393
    top: SCREEN_HEIGHT * 0.090,  // 77/852
  },
  ...
  statusSection: {
    ...
    left: SCREEN_WIDTH * 0.053,  // 21/393
    top: SCREEN_HEIGHT * 0.513,  // 437/852
  ...
  timerBarContainer: {
    ...
    left: SCREEN_WIDTH * 0.127,  // 50/393
    top: SCREEN_HEIGHT * 0.076,  // 65/852
    alignItems: 'center',
  },
  ...
  actionButtons: {
    ...
    left: SCREEN_WIDTH * 0.153,  // 60/393
    top: SCREEN_HEIGHT * 0.683,  // 582/852
  },
  ...
  orangeTheme: {
    ...
    left: 0,
    top: SCREEN_HEIGHT * 0.744,  // 634/852
    borderRadius: 20,
    padding: 20,
  },
  ...
  speechBubble: {
    ...
    left: SCREEN_WIDTH * 0.043,  // 17/393
    top: SCREEN_HEIGHT * 0.015,  // 13/852
  ...
  habitButtons: {
    ...
    justifyContent: 'space-between',
    alignItems: 'center',
    width: SCREEN_WIDTH - (SCREEN_WIDTH * 0.102),  // width - 40
    left: SCREEN_WIDTH * 0.051,  // 20/393
    top: SCREEN_HEIGHT * 0.141,  // 120/852
    gap: 10,
  },
  ...
  // Volume Button - Relative positioning
  volumeButtonContainer: {
    position: 'absolute',
    top: SCREEN_HEIGHT * 0.090,  // 60/852 = 0.070 (7% down from top)
    left: SCREEN_WIDTH * 0.041,  // 16/393 = 0.041 (4.1% from left)
    zIndex: 100,
  },
