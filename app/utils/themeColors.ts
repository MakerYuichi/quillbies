...
export const getThemeDecorations = (themeType?: string) => {
  ...
  const decorations: { [key: string]: Array<{ emoji: string; top: number; left: number; size: number }> } = {
    'ocean': [
      ...
      // Center area (10-60% top) - NEW
      { emoji: '🐠', top: 12, left: 20, size: 20 },
      { emoji: '🐟', top: 18, left: 75, size: 18 },
      { emoji: '🐡', top: 25, left: 40, size: 22 },
      { emoji: '💧', top: 32, left: 10, size: 14 },
      { emoji: '🐠', top: 38, left: 85, size: 18 },
      { emoji: '🌿', top: 45, left: 30, size: 20 },
      { emoji: '🐟', top: 52, left: 60, size: 16 },
      { emoji: '💧', top: 15, left: 55, size: 12 },
      { emoji: '🐡', top: 22, left: 8, size: 20 },
      { emoji: '🐠', top: 28, left: 70, size: 18 },
      { emoji: '🌿', top: 35, left: 45, size: 18 },
      { emoji: '💧', top: 42, left: 15, size: 10 },
      { emoji: '🐟', top: 48, left: 88, size: 16 },
      { emoji: '🐡', top: 55, left: 25, size: 20 },
    ...
    'space': [
      ...
      // Center area (10-60% top) - NEW
      { emoji: '⭐', top: 12, left: 18, size: 16 },
      { emoji: '✨', top: 19, left: 72, size: 16 },
      { emoji: '🌟', top: 26, left: 35, size: 18 },
      { emoji: '💫', top: 33, left: 58, size: 16 },
      { emoji: '🚀', top: 40, left: 12, size: 22 },
      { emoji: '⭐', top: 47, left: 80, size: 14 },
      { emoji: '✨', top: 54, left: 45, size: 14 },
      { emoji: '🌟', top: 15, left: 88, size: 16 },
      { emoji: '💫', top: 22, left: 8, size: 14 },
      { emoji: '⭐', top: 29, left: 65, size: 12 },
      { emoji: '✨', top: 36, left: 25, size: 12 },
      { emoji: '🌟', top: 43, left: 90, size: 16 },
      { emoji: '💫', top: 50, left: 30, size: 14 },
      { emoji: '🚀', top: 57, left: 70, size: 20 },
    ...
    'galaxy': [
      ...
      // Center area (10-60% top) - NEW
      { emoji: '✨', top: 13, left: 22, size: 18 },
      { emoji: '🌟', top: 20, left: 68, size: 18 },
      { emoji: '💫', top: 27, left: 40, size: 20 },
      { emoji: '⭐', top: 34, left: 15, size: 16 },
      { emoji: '✨', top: 41, left: 78, size: 16 },
      { emoji: '🌟', top: 48, left: 32, size: 16 },
      { emoji: '💫', top: 55, left: 60, size: 18 },
      { emoji: '⭐', top: 16, left: 85, size: 14 },
      { emoji: '✨', top: 23, left: 10, size: 16 },
      { emoji: '🌟', top: 30, left: 52, size: 16 },
      { emoji: '💫', top: 37, left: 88, size: 18 },
      { emoji: '⭐', top: 44, left: 25, size: 14 },
      { emoji: '✨', top: 51, left: 70, size: 16 },
      { emoji: '🌟', top: 58, left: 45, size: 16 },
      // Scrollable content area
    ...
    'japanese-zen': [
      ...
      // Center area (10-60% top) - NEW
      { emoji: '🎋', top: 13, left: 18, size: 24 },
      { emoji: '🍃', top: 20, left: 72, size: 18 },
      { emoji: '🎋', top: 27, left: 35, size: 22 },
      { emoji: '🍃', top: 34, left: 8, size: 16 },
      { emoji: '🎋', top: 41, left: 80, size: 20 },
      { emoji: '🍃', top: 48, left: 45, size: 16 },
      { emoji: '🎋', top: 55, left: 15, size: 22 },
      { emoji: '🍃', top: 16, left: 88, size: 16 },
      { emoji: '🎋', top: 23, left: 52, size: 20 },
      { emoji: '🍃', top: 30, left: 25, size: 14 },
      { emoji: '🎋', top: 37, left: 65, size: 22 },
      { emoji: '🍃', top: 44, left: 10, size: 16 },
      { emoji: '🎋', top: 51, left: 75, size: 20 },
      { emoji: '🍃', top: 58, left: 38, size: 14 },
      // Scrollable content area
    ...
    'castle': [
      ...
      // Center area (10-60% top) - NEW
      { emoji: '⚔️', top: 14, left: 20, size: 20 },
      { emoji: '🛡️', top: 21, left: 68, size: 22 },
      { emoji: '👑', top: 28, left: 35, size: 24 },
      { emoji: '⚔️', top: 35, left: 12, size: 18 },
      { emoji: '🛡️', top: 42, left: 78, size: 20 },
      { emoji: '👑', top: 49, left: 48, size: 22 },
      { emoji: '⚔️', top: 56, left: 8, size: 18 },
      { emoji: '🛡️', top: 17, left: 88, size: 20 },
      { emoji: '👑', top: 24, left: 52, size: 22 },
      { emoji: '⚔️', top: 31, left: 25, size: 16 },
      { emoji: '🛡️', top: 38, left: 70, size: 20 },
      { emoji: '👑', top: 45, left: 15, size: 22 },
      { emoji: '⚔️', top: 52, left: 82, size: 18 },
      { emoji: '🛡️', top: 59, left: 40, size: 20 },
      // Scrollable content area
    ...
    'library': [
      ...
      // Center area (10-60% top) - NEW
      { emoji: '📕', top: 13, left: 22, size: 22 },
      { emoji: '📗', top: 20, left: 65, size: 20 },
      { emoji: '📘', top: 27, left: 38, size: 22 },
      { emoji: '📙', top: 34, left: 10, size: 20 },
      { emoji: '📚', top: 41, left: 75, size: 24 },
      { emoji: '📕', top: 48, left: 45, size: 20 },
      { emoji: '📗', top: 55, left: 18, size: 18 },
      { emoji: '📘', top: 16, left: 82, size: 20 },
      { emoji: '📙', top: 23, left: 52, size: 18 },
      { emoji: '📚', top: 30, left: 8, size: 22 },
      { emoji: '📕', top: 37, left: 88, size: 20 },
      { emoji: '📗', top: 44, left: 28, size: 18 },
      { emoji: '📘', top: 51, left: 68, size: 20 },
      { emoji: '📙', top: 58, left: 35, size: 18 },
      // Scrollable content area
    ...
    'night': [
      ...
      // Center area (10-60% top) - NEW
      { emoji: '🌙', top: 15, left: 75, size: 26 },
      { emoji: '⭐', top: 22, left: 20, size: 16 },
      { emoji: '✨', top: 29, left: 55, size: 14 },
      { emoji: '🌟', top: 36, left: 10, size: 18 },
      { emoji: '⭐', top: 43, left: 82, size: 14 },
      { emoji: '✨', top: 50, left: 38, size: 12 },
      { emoji: '🌟', top: 57, left: 65, size: 16 },
      { emoji: '⭐', top: 18, left: 45, size: 14 },
      { emoji: '✨', top: 25, left: 8, size: 12 },
      { emoji: '🌟', top: 32, left: 88, size: 16 },
      { emoji: '⭐', top: 39, left: 28, size: 12 },
      { emoji: '✨', top: 46, left: 70, size: 12 },
      { emoji: '🌟', top: 53, left: 15, size: 14 },
      { emoji: '⭐', top: 60, left: 50, size: 12 },
      // Scrollable content area
